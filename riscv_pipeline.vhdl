...
----------------------------------------------------------------------------------------
    ...
    next_pc <= std_logic_vector(signed(ex_mem_npc) + signed(ex_mem_imm)) when (ex_mem_branch = '1' and not_equal_flag = '1') else
               std_logic_vector(signed(ex_mem_npc) + signed(ex_mem_imm)) when (ex_mem_jump = '1') else
               ex_mem_npc; -- note: this happens during IF !!! 1st two during MEM
