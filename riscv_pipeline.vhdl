...
----------------------------------------------------------------------------------------
    ...
    next_pc <= std_logic_vector(signed(NPC) + signed(ex_mem_imm)) when (ex_mem_branch = '1' and not_equal_flag = '1') else
               std_logic_vector(signed(NPC) + signed(ex_mem_imm)) when (ex_mem_jump = '1') else
